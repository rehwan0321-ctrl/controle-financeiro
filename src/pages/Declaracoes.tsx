...
function gerarPDF(data: FormData) {
  ...
  <style>
    @page{size:A4 portrait;margin:0.5cm 1cm 2cm 1cm;}
    ...
    h1{text-align:center;font-size:18pt;font-weight:bold;margin-top:0;margin-bottom:calc(0.6em + 1.5cm);line-height:1.15;}
